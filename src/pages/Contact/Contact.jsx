        ...
        <div className="contact-hero__grid">
          ...
          >
            <div className="contact-label">
              <span />
              Contact Godavari Iron &amp; Steel
            </div>

            <h1>
              Let’s Discuss Your
              <span>Steel Requirement</span>
            </h1>

            <p>
              Share your product, grade, size, quantity, application and
              delivery location. Our team will help coordinate a suitable
          ...
          >
            <div className="contact-hero__visual-card">
              ...
              <span>Project &amp; Product Support</span>

              <strong>
                Connect with Our Steel Supply Team
              </strong>

              <p>
                Product enquiries, project planning, quotations and
    ...
    >
      <div className="container contact-main__grid">
        ...
        >
          ...
          <h2>
            Tell Us What You Need. We’ll Help You Plan the Supply.
          </h2>

          <p>
            Fill in the form with your product, grade, dimensions,
            quantity and delivery requirement. Our team will contact you
            with the next steps.
          </p>
          ...
          <div className="contact-main__points">
            ...
            <div>
              <CheckCircle2 size={18} />
              <span>Project-based quotation support</span>
            </div>

            <div>
              <CheckCircle2 size={18} />
              <span>Processing and dispatch coordination</span>
            </div>

            <div>
              <CheckCircle2 size={18} />
              <span>Pan-India supply assistance</span>
            </div>
          </div>
          ...
          <div className="contact-main__direct">
            <a href={`tel:${companyContact.phoneHref}`}>
              ...
              <span>
                <small>Call Us</small>
                <strong>{companyContact.phone}</strong>
              </span>
            </a>
        ...
        >
          ...
          <small className="contact-form__note">
            This frontend form is ready for API integration when the backend
            is added.
          </small>
        </motion.form>
      </div>
    ...
    <section className="contact-highlights">
      <div className="container">
        <div className="contact-heading contact-heading--light">
          ...
          <h2>
            Clear Communication for Better Project Coordination
          </h2>

          <p>
            We make it easy to share requirements, clarify specifications
    ...
    >
      <div className="container contact-map__grid">
        ...
        >
          ...
          <h2>
            Visit Godavari Iron &amp; Steel
          </h2>

          <p>
            Meet our team to discuss product requirements, project supply,
            processing support and delivery coordination.
          </p>
          ...
          <div className="contact-map__address">
            ...
            <div>
              <small>Address</small>
              <strong>{companyContact.address}</strong>
            </div>
          </div>

          <a
            href="https://maps.google.com/?q=Rajahmundry%20Andhra%20Pradesh"
            target="_blank"
            rel="noreferrer"
            className="contact-primary-button"
          >
        ...
        >
          <iframe
            title="Godavari Iron and Steel location"
            src={companyContact.mapEmbed}
            loading="lazy"
    ...
    <section className="contact-cta">
      <div className="container contact-cta__container">
        <div>
          ...
          <h2>
            Share Your Steel Requirement with Our Team
          </h2>

          <p>
            Send your specifications, quantity and delivery location. We’ll
            help you plan a suitable supply solution.
          </p>
        </div>
