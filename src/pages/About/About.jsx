...
const capabilities = [
  { icon: Factory, value: "27+", label: "Years in Steel" },
  { icon: Gauge, value: "6,00,000 MT", label: "Annual Capacity" },
  { icon: Truck, value: "18", label: "States Served" },
  { icon: Users, value: "1,450+", label: "Projects Supplied" },
];
      ...
      <div className="container">
        ...
        <div className="about-hero__grid">
          ...
          >
            ...
            <h1>
              Built on Discipline.
              <span>Trusted Through Performance.</span>
            </h1>

            <p>
              Godavari Iron &amp; Steel supports construction,
              infrastructure, engineering and manufacturing businesses through
              reliable steel products, disciplined operations and dependable
              project support.
            </p>
            ...
            <div className="about-hero__actions">
              ...
              <Link to="/infrastructure" className="about-hero__text-link">
          ...
          >
            <div className="about-hero__image-card">
              ...
              <div className="about-hero__image-content">
                ...
                <strong>Steel Solutions Built for Demanding Projects</strong>
              </div>
            </div>
            ...
            <div className="about-hero__floating-card">
              ...
              <div>
                ...
                <span>Verification and traceability</span>
              </div>
            </div>
    ...
    <section className="about-story">
      <div className="container about-story__grid">
        ...
        >
          ...
          <h2>A Dependable Steel Partner for Modern Industrial Requirements</h2>

          <p>
            Godavari Iron &amp; Steel was established with a clear objective:
            provide quality steel products through dependable service,
            disciplined operations and transparent customer support.
          </p>

          <p>
            Over the years, the company has developed stronger processing,
            warehousing, quality verification and logistics capabilities to
            support projects of different sizes and technical requirements.
          </p>
        ...
        >
          <div className="about-story__main-image">
            <img src={plantImage} alt="Godavari steel manufacturing plant" />
          </div>

          <div className="about-story__secondary-image">
            <img src={machineryImage} alt="Steel processing machinery" />
          </div>

          <div className="about-story__experience">
            <strong>27+</strong>
            <span>Years of industrial experience</span>
          </div>
        </motion.div>
      </div>
    </section>
    ...
    <section className="about-purpose">
      <div className="container">
        <div className="about-purpose__heading">
          ...
          <h2>Built Around Quality, Trust and Long-Term Growth</h2>
        </div>
        ...
        <div className="about-purpose__grid">
          ...
          >
            ...
            <h3>Our Mission</h3>
            <p>
              To deliver dependable iron and steel products through disciplined
              quality systems, responsive support and reliable project
              execution.
            </p>
          </motion.article>
          ...
          >
            ...
            <h3>Our Vision</h3>
            <p>
              To become a trusted industrial steel partner recognized for
              quality, operational excellence and long-term customer
              relationships.
            </p>
          </motion.article>
        </div>
    ...
    <section className="about-journey">
      <div className="container">
        <div className="about-journey__heading">
          ...
          <h2>Growing Through Every Stage of India’s Industrial Development</h2>

          <p>
            Each stage of growth strengthened our capabilities, service quality
            and ability to support more demanding projects.
          </p>
        </div>
        ...
        <div className="about-journey__timeline">
          {milestones.map((milestone, index) => (
            ...
            >
              <div className="about-journey__year">{milestone.year}</div>
    ...
    <section className="about-values">
      <div className="container">
        <div className="about-values__heading">
          ...
          <h2>The Principles Behind Every Product and Partnership</h2>
        </div>
    ...
    <section className="about-infrastructure">
      <div className="container about-infrastructure__grid">
        ...
        >
          ...
          <h2>Integrated Facilities Supporting Reliable Steel Supply</h2>

          <p>
            Our operations combine processing, quality verification,
            warehousing, material handling and dispatch planning through one
            coordinated system.
          </p>

          <Link to="/infrastructure" className="about-outline-button">
            Explore Infrastructure
            <ArrowRight size={18} />
          </Link>
        </motion.div>
        ...
        >
          <article>
            <img src={machineryImage} alt="Steel processing equipment" />
            <div>
              <Factory size={23} />
          ...
          <article>
            <img src={warehouseImage} alt="Steel warehouse and logistics" />
            <div>
              <Truck size={23} />
    ...
    <section className="about-quality">
      <div className="container about-quality__grid">
        <motion.div
          ...
          transition={{ duration: 0.65 }}
        >
          <img src={qualityImage} alt="Steel quality verification laboratory" />
        ...
        >
          ...
          <h2>Confidence Built Into Every Batch</h2>

          <p>
            Quality is managed through inspection, dimensional verification,
            testing, product traceability and controlled handling before
            dispatch.
          </p>
          ...
          <Link to="/quality" className="about-primary-button">
    ...
    <section className="about-cta">
      <div className="container about-cta__container">
        <div>
          ...
          <h2>Partner with a Team That Understands Steel</h2>
          <p>
            Share your grade, size, quantity and project requirement with our
            team for suitable product guidance and quotation support.
          </p>
        </div>

        <div className="about-cta__actions">
          <Link to="/quote" className="about-cta__primary">
            Request a Quote
            <ArrowRight size={18} />
          </Link>
